...
for i,(slug,title,desc,group) in enumerate(PAGES):
 ...
 review_date = '2026-09-23' if slug in ('17-game-over', '18-environment', '19-riktiga-monster') else '2026-09-22'
